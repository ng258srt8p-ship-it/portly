  ...
  return (
    ...
    >
        ...
        <details data-sailing-subnav-popover className="group">
          ...
          >
            <span className="flex items-center gap-2">
              <MaterialIcon name="directions_boat_filled" size="xs" className="text-indigo" />
              {activeSection.label}
           </span>
      ...
      <div className={"hidden md:flex " + pillBase + " items-center gap-1 px-2 py-2"}>
        ...
        <nav className="flex flex-1 min-w-0 items-center gap-1 overflow-x-auto scrollbar-none" aria-label="Sections">
          {sections.map((sec) => (
            <button
              key={sec.id}
              type="button"
