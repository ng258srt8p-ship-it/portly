...
export class HollandAmericaLineAdapter extends SourceAdapter {
  ...
  private parseCardText(rawText: string, lines: string[]): SailingRecord | null {
    ...
    let departurePort = '';
    const portKw = ['Miami', 'Fort Lauderdale', 'Port Canaveral', 'Tampa', 'Galveston', 'Los Angeles', 'Long Beach', 'San Diego', 'Seattle', 'Vancouver', 'Sydney', 'Barcelona', 'Rome', 'Venice', 'Southampton', 'Singapore', 'Auckland'];
