...
test.describe('Font Rendering', () => {
  test('page title uses display font (Syne or Clash Display, not system-ui)', async ({ page }) => {
    await page.goto('/');
    await page.waitForSelector('h1', { timeout: 10000 });
    ...
    // Should contain Syne or Clash Display
    expect(fontFamily).toMatch(/Syne|Clash Display/);
  });
});
