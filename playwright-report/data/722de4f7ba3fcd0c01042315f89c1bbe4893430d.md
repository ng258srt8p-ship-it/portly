...
- Name: phase6-accessibility.spec.ts >> Phase 6 — WCAG AA Contrast & Accessibility >> Empty state values use muted text colors
- Location: e2e/phase6-accessibility.spec.ts:64:7
